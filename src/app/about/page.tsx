    ...
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-white to-stone-100">
      ...
      >
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          {/* Factsheet Content */}
          <motion.div 
            className="max-w-5xl mx-auto px-6 py-12 space-y-8 text-gray-800"
            variants={staggerChildren}
          >
            <motion.h2 
              className="text-2xl md:text-3xl font-semibold text-gray-900 border-l-4 border-yellow-500 pl-3 mb-4"
              variants={fadeInUp}
            >
              Factsheet
            </motion.h2>
            ...
            >
              <motion.div variants={fadeInUp}>
                <h3 className="text-xl font-medium text-amber-600 mt-8 mb-4">Basic Information</h3>
              ...
              <motion.div variants={fadeInUp}>
                <h3 className="text-xl font-medium text-amber-600 mt-8 mb-4">Manufacturing Facilities & Distributors</h3>
              ...
              <motion.div variants={fadeInUp}>
                <h3 className="text-xl font-medium text-amber-600 mt-8 mb-4">Quality Assurance</h3>
                <p className="text-gray-700 leading-relaxed">All our disposable items undergo strict quality control and are sterilized thoroughly before being placed inside the First Aid Boxes.</p>
              </motion.div>

              <motion.div variants={fadeInUp}>
                <h3 className="text-xl font-medium text-amber-600 mt-8 mb-4">Product Portfolio</h3>
                <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <motion.div variants={fadeInUp}>
                <h3 className="text-xl font-medium text-amber-600 mt-8 mb-4">Customization</h3>
                <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <motion.div variants={fadeInUp}>
                <h3 className="text-xl font-medium text-amber-600 mt-8 mb-4">Our Clientele</h3>
                <div className="space-y-4 text-gray-700 leading-relaxed">
